...
export default function QuizTwoPage() {
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Membiarkan sampah di jalan</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Menunggu orang lain</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Buang ke tempat sampah</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Salahkan teman</span>
          </label>
        </div>
      </div>
