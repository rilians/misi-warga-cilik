...
export default function QuizThreePage() {
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Agar kita boleh bermain</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Agar semua merasa adil</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Tidak perlu aturan</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Hanya diri sendiri senang</span>
          </label>
        </div>
      </div>
