...
const CORRECT_ANSWER = 'C' as const;

export default function QuizFourPage() {
    ...
    <div className="relative h-screen w-full overflow-hidden bg-white">
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          <label 
            className={`flex items-center min-h-[36px] py-1 rounded-[12px] border-2 px-2 cursor-pointer transition-transform ${
              selectedAnswer === 'A'
                ? CA === 'A'
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Ikut mencoret bangku</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Membiarkan karena bukan milik</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Menjaga fasilitas umum</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Duduk lalu pergi begitu saja</span>
          </label>
        </div>
      </div>
