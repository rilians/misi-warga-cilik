...
export default function QuizFivePage() {
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Merusaknya</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Memiliki sendiri</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Menjualnya</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Merawat fasilitas</span>
          </label>
        </div>
      </div>
