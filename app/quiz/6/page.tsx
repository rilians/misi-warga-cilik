...
export default function QuizSixPage() {
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Berlari tanpa lihat</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Di zebra cross aman</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Sambil bercanda</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[14px] font-bold text-[#341d38]">Ikuti teman tanpa lihat</span>
          </label>
        </div>
      </div>
