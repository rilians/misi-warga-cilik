...
export default function QuizEightPage() {
      ...
      <div className="absolute left-1/2 top-[66%] z-10 w-[220px] max-w-[220px] lg:w-[220px] -translate-x-1/2 -translate-y-1/2">
        <div className="space-y-2">
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Memaksakan pendapat</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Mencari keputusan bersama</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Membuat teman takut</span>
          </label>
          ...
          >
            ...
            <span className="ml-2 text-[13px] font-bold text-[#341d38] line-clamp-2">Menghindari tanggung jawab</span>
          </label>
        </div>
      </div>
